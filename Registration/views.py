...
# my_dict = {'Insert_Me': "I am a text from Registration/Views.py now from sub templates", 'Insert_Shivu':"Shivu is becoming more punctual these days"}
...
#    batch_list = Batch.objects.raw('select * from Registration_Batch where start_date >"2021-06-01"')
    ...
    data_dict = {'access_record': batch_list,'Insert_Me': "I am a text from Registration/Views.py", 'Insert_Shivu':"Shivu is becoming more punctual these days" }
